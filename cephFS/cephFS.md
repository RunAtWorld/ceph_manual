...
# Check列表
- [ ] MDS 容量预估 : [https://mp.weixin.qq.com/s/R8TC-S6h_gHPaokTGTqKeQ](https://mp.weixin.qq.com/s/R8TC-S6h_gHPaokTGTqKeQ)
- [ ] CephFS 的资源配额管理 / 机制 
	  配额机制详解 - 配额机制 
-----------------------
- [ ] MDS 主要配置
...
1. 查看ceph mds 的ops
```
ceph daemon /var/run/ceph/ceph-mds.ip-172-20-102-32.asok ops
```
